...
let rec _menhir_goto_list_stmt_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.stmt list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState104 ->
        ...
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _endpos_x_, _menhir_s, (x : (Ptree.stmt))), _, (xs : (Ptree.stmt list))) = _menhir_stack in
        let _v : (Ptree.stmt list) = 
# 213 "<standard.mly>"
    ( x :: xs )
# 132 "parser.ml"
         in
    ...
    | MenhirState40 ->
        ...
        | RBRACE ->
            ...
            let (((_menhir_stack, _menhir_s, _startpos__1_), _, (vl : (Ptree.decl_var list list))), _, (sl : (Ptree.stmt list))) = _menhir_stack in
            let _4 = () in
            let _1 = () in
...
# 154 "parser.ml"
            ...
            | MenhirState40 | MenhirState104 | MenhirState87 | MenhirState95 | MenhirState98 ->
                ...
                let (_1 : (Ptree.block)) = _v in
                let _startpos__1_ = _startpos in
                let _startpos = _startpos__1_ in
                let _endpos = _endpos__1_ in
                let _v : (Ptree.stmt_node) = 
# 164 "parser.mly"
   ( Sblock _1 )
# 168 "parser.ml"
                 in
                _menhir_goto_stmt_node _menhir_env _menhir_stack _endpos _menhir_s _v _startpos
            | MenhirState38 ->
                let _menhir_stack = Obj.magic _menhir_stack in
                let _menhir_stack = Obj.magic _menhir_stack in
                let _endpos_body_ = _endpos in
                let (body : (Ptree.block)) = _v in
                let _startpos_body_ = _startpos in
                let ((((_menhir_stack, _menhir_s, (f : (Ptree.decl_var))), _startpos__2_), _, (fl : (Ptree.decl_var list))), _endpos__4_) = _menhir_stack in
                let _4 = () in
                let _2 = () in
                let _v : (Ptree.decl_fun) = 
# 84 "parser.mly"
    ( let ty, id = f in
      { fun_typ = ty;
	fun_name = id;
...
and _menhir_goto_decl : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.decl) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
...
and _menhir_goto_stmt_node : _menhir_env -> 'ttv_tail -> Lexing.position -> _menhir_state -> (Ptree.stmt_node) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _endpos _menhir_s _v _startpos ->
    let _menhir_stack = Obj.magic _menhir_stack in
    let _menhir_stack = Obj.magic _menhir_stack in
    let _endpos_s_ = _endpos in
    let (s : (Ptree.stmt_node)) = _v in
    let _startpos_s_ = _startpos in
    let _endpos = _endpos_s_ in
    let _v : (Ptree.stmt) = let _endpos = _endpos_s_ in
...
# 249 "parser.ml"
    ...
    | MenhirState95 ->
        ...
        | BANG | IDENT _ | IF | INTEGER _ | LBRACE | LPAR | MINUS | RBRACE | RETURN | SEMICOLON | SIZEOF | WHILE ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((((_menhir_stack, _menhir_s, _startpos__1_), _startpos__2_), _endpos__3_, _, (_3 : (Ptree.expr)), _startpos__3_), _endpos__4_), _endpos__5_, _, (_5 : (Ptree.stmt))) = _menhir_stack in
            let _4 = () in
            let _2 = () in
            let _1 = () in
            let _startpos = _startpos__1_ in
            let _endpos = _endpos__5_ in
            let _v : (Ptree.stmt_node) = let _endpos = _endpos__5_ in
            let _startpos = _startpos__1_ in
...
# 302 "parser.ml"
    ...
    | MenhirState98 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((((((_menhir_stack, _menhir_s, _startpos__1_), _startpos__2_), _endpos__3_, _, (_3 : (Ptree.expr)), _startpos__3_), _endpos__4_), _endpos__5_, _, (_5 : (Ptree.stmt))), _endpos__7_, _, (_7 : (Ptree.stmt))) = _menhir_stack in
        let _6 = () in
        let _4 = () in
        let _2 = () in
        let _1 = () in
...
and _menhir_goto_separated_nonempty_list_COMMA_expr_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.expr list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState55 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (x : (Ptree.expr list)) = _v in
        let _v : (Ptree.expr list) = 
# 144 "<standard.mly>"
    ( x )
# 516 "parser.ml"
         in
    ...
    | MenhirState79 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (xs : (Ptree.expr list)) = _v in
        let (_menhir_stack, _endpos_x_, _menhir_s, (x : (Ptree.expr)), _startpos_x_) = _menhir_stack in
        let _2 = () in
        let _v : (Ptree.expr list) = 
# 243 "<standard.mly>"
    ( x :: xs )
...
and _menhir_run61 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> 'ttv_return =
...
and _menhir_run63 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    match _tok with
...
and _menhir_run67 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    match _tok with
...
and _menhir_run69 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    match _tok with
...
and _menhir_run71 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> Lexing.position -> 'ttv_return =
...
and _menhir_run73 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> (
# 32 "parser.mly"
       (Ptree.binop)
# 648 "parser.ml"
) -> 'ttv_return =
...
and _menhir_run75 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> (
# 33 "parser.mly"
       (Ptree.binop)
# 675 "parser.ml"
) -> 'ttv_return =
...
and _menhir_run65 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    match _tok with
...
and _menhir_run77 : _menhir_env -> 'ttv_tail * Lexing.position * _menhir_state * (Ptree.expr) * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    match _tok with
...
and _menhir_goto_decl_var : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.decl_var list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
...
and _menhir_goto_separated_nonempty_list_COMMA_formal_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.decl_var list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState32 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (x : (Ptree.decl_var list)) = _v in
        let _v : (Ptree.decl_var list) = 
# 144 "<standard.mly>"
    ( x )
# 761 "parser.ml"
         in
        _menhir_goto_loption_separated_nonempty_list_COMMA_formal__ _menhir_env _menhir_stack _menhir_s _v
    | MenhirState110 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (xs : (Ptree.decl_var list)) = _v in
        let (_menhir_stack, _menhir_s, (x : (Ptree.decl_var))) = _menhir_stack in
        let _2 = () in
        let _v : (Ptree.decl_var list) = 
# 243 "<standard.mly>"
    ( x :: xs )
# 773 "parser.ml"
         in
        _menhir_goto_separated_nonempty_list_COMMA_formal_ _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()

and _menhir_goto_loption_separated_nonempty_list_COMMA_formal__ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.decl_var list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = Obj.magic _menhir_stack in
    let _menhir_stack = Obj.magic _menhir_stack in
    let (xs : (Ptree.decl_var list)) = _v in
    let _v : (Ptree.decl_var list) = let f = 
# 232 "<standard.mly>"
    ( xs )
# 787 "parser.ml"
     in
...
and _menhir_goto_list_decl_var_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.decl_var list list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState6 ->
        ...
        | RBRACE ->
            ...
            | SEMICOLON ->
                ...
                let (((((_menhir_stack, _menhir_s), _endpos_s_, _, (s : (Ptree.ident)), _startpos_s_), _startpos__3_), _, (fl : (Ptree.decl_var list list))), _endpos__5_) = _menhir_stack in
                let _6 = () in
                let _5 = () in
                let _3 = () in
                let _1 = () in
...
# 864 "parser.ml"
    ...
    | MenhirState25 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, (x : (Ptree.decl_var list))), _, (xs : (Ptree.decl_var list list))) = _menhir_stack in
        let _v : (Ptree.decl_var list list) = 
# 213 "<standard.mly>"
    ( x :: xs )
# 886 "parser.ml"
         in
...
and _menhir_goto_lvalue : _menhir_env -> 'ttv_tail -> Lexing.position -> _menhir_state -> (Ptree.lvalue) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _endpos _menhir_s _v _startpos ->
    ...
    | AMPERSANDAMPERSAND | ARROW | COMMA | COMP _ | EQOP _ | MINUS | PLUS | RPAR | SEMICOLON | SLASH | STAR | VERTICALBARVERTICALBAR ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_menhir_stack, _endpos__1_, _menhir_s, (_1 : (Ptree.lvalue)), _startpos__1_) = _menhir_stack in
        let _startpos = _startpos__1_ in
        let _endpos = _endpos__1_ in
        let _v : (Ptree.expr_node) = 
# 114 "parser.mly"
    ( Eright _1 )
# 966 "parser.ml"
         in
        _menhir_goto_expr_node _menhir_env _menhir_stack _endpos _menhir_s _v _startpos
    | _ ->
        assert (not _menhir_env._menhir_error);
        _menhir_env._menhir_error <- true;
        let _menhir_stack = Obj.magic _menhir_stack in
...
and _menhir_goto_loption_separated_nonempty_list_COMMA_expr__ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.expr list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
    ...
    | RPAR ->
        ...
        let _menhir_stack = Obj.magic _menhir_stack in
        let _endpos__4_ = _endpos in
        let (((_menhir_stack, _endpos_id_, _menhir_s, (id : (Ptree.ident)), _startpos_id_), _startpos__2_), _, (xs : (Ptree.expr list))) = _menhir_stack in
        let _4 = () in
        let _2 = () in
        let _startpos = _startpos_id_ in
        let _endpos = _endpos__4_ in
        let _v : (Ptree.expr_node) = let el = 
# 232 "<standard.mly>"
    ( xs )
# 997 "parser.ml"
         in
...
and _menhir_goto_expr_node : _menhir_env -> 'ttv_tail -> Lexing.position -> _menhir_state -> (Ptree.expr_node) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _endpos _menhir_s _v _startpos ->
    let _menhir_stack = Obj.magic _menhir_stack in
    let _menhir_stack = Obj.magic _menhir_stack in
    let _endpos_e_ = _endpos in
    let (e : (Ptree.expr_node)) = _v in
    let _startpos_e_ = _startpos in
    let _startpos = _startpos_e_ in
    let _endpos = _endpos_e_ in
    let _v : (Ptree.expr) = let _endpos = _endpos_e_ in
    let _startpos = _startpos_e_ in
...
# 1210 "parser.ml"
    ...
    | MenhirState61 ->
        ...
        | COMMA | RPAR | SEMICOLON | VERTICALBARVERTICALBAR ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, _endpos__1_, _menhir_s, (_1 : (Ptree.expr)), _startpos__1_), _endpos__3_, _, (_3 : (Ptree.expr)), _startpos__3_) = _menhir_stack in
            let _2 = () in
            let _startpos = _startpos__1_ in
...
# 1328 "parser.ml"
    ...
    | MenhirState71 ->
        ...
        | AMPERSANDAMPERSAND | COMMA | COMP _ | EQOP _ | MINUS | PLUS | RPAR | SEMICOLON | VERTICALBARVERTICALBAR ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((_menhir_stack, _endpos__1_, _menhir_s, (_1 : (Ptree.expr)), _startpos__1_), _startpos__2_), _endpos__3_, _, (_3 : (Ptree.expr)), _startpos__3_) = _menhir_stack in
            let _2 = () in
            let _startpos = _startpos__1_ in
            let _endpos = _endpos__3_ in
            let _v : (Ptree.expr_node) = 
...
# 1357 "parser.ml"
    ...
    | MenhirState73 ->
        ...
        | AMPERSANDAMPERSAND | COMMA | EQOP _ | RPAR | SEMICOLON | VERTICALBARVERTICALBAR ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((_menhir_stack, _endpos__1_, _menhir_s, (_1 : (Ptree.expr)), _startpos__1_), (_2 : (
# 32 "parser.mly"
       (Ptree.binop)
# 1388 "parser.ml"
            ))), _endpos__3_, _, (_3 : (Ptree.expr)), _startpos__3_) = _menhir_stack in
            let _startpos = _startpos__1_ in
            let _endpos = _endpos__3_ in
            let _v : (Ptree.expr_node) = 
# 122 "parser.mly"
...
# 1468 "parser.ml"
    ...
    | MenhirState53 ->
        ...
        | COMMA | RPAR | SEMICOLON ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, _endpos__1_, _menhir_s, (_1 : (Ptree.lvalue)), _startpos__1_), _endpos__3_, _, (_3 : (Ptree.expr)), _startpos__3_) = _menhir_stack in
            let _2 = () in
            let _startpos = _startpos__1_ in
            let _endpos = _endpos__3_ in
            let _v : (Ptree.expr_node) = 
...
# 1509 "parser.ml"
    ...
    | MenhirState51 ->
        ...
        | AMPERSANDAMPERSAND | COMMA | COMP _ | EQOP _ | MINUS | PLUS | RPAR | SEMICOLON | SLASH | STAR | VERTICALBARVERTICALBAR ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, _menhir_s, _startpos__1_), _endpos__2_, _, (_2 : (Ptree.expr)), _startpos__2_) = _menhir_stack in
            let _1 = () in
            let _startpos = _startpos__1_ in
...
# 1709 "parser.ml"
    ...
    | MenhirState40 | MenhirState104 | MenhirState87 | MenhirState95 | MenhirState98 ->
        ...
        | SEMICOLON ->
            ...
            let (_menhir_stack, _endpos__1_, _menhir_s, (_1 : (Ptree.expr)), _startpos__1_) = _menhir_stack in
            let _2 = () in
            let _startpos = _startpos__1_ in
            let _endpos = _endpos__2_ in
            let _v : (Ptree.stmt_node) = 
...
and _menhir_goto_separated_nonempty_list_COMMA_ident_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.ident list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState16 ->
        ...
        | SEMICOLON ->
            ...
            let _endpos__3_ = _endpos in
            let _startpos__3_ = _startpos in
            let ((_menhir_stack, _menhir_s), _, (vl : (Ptree.ident list))) = _menhir_stack in
            let _3 = () in
            let _1 = () in
            let _v : (Ptree.decl_var list) = 
# 73 "parser.mly"
...
# 1859 "parser.ml"
    ...
    | MenhirState20 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _endpos_x_, _menhir_s, (x : (Ptree.ident)), _startpos_x_), _, (xs : (Ptree.ident list))) = _menhir_stack in
        let _2 = () in
        let _v : (Ptree.ident list) = 
# 243 "<standard.mly>"
    ( x :: xs )
# 1876 "parser.ml"
         in
...
and _menhir_goto_separated_nonempty_list_COMMA_star_ident_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.ident list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState12 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, (x : (Ptree.ident))), _, (xs : (Ptree.ident list))) = _menhir_stack in
        let _2 = () in
        let _v : (Ptree.ident list) = 
# 243 "<standard.mly>"
    ( x :: xs )
# 1894 "parser.ml"
         in
        _menhir_goto_separated_nonempty_list_COMMA_star_ident_ _menhir_env _menhir_stack _menhir_s _v
    | MenhirState8 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        ...
        | SEMICOLON ->
            ...
            let (((_menhir_stack, _menhir_s), _endpos_s_, _, (s : (Ptree.ident)), _startpos_s_), _, (vl : (Ptree.ident list))) = _menhir_stack in
            let _4 = () in
            let _1 = () in
            let _v : (Ptree.decl_var list) = 
# 75 "parser.mly"
...
and _menhir_goto_formal : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.decl_var) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
...
and _menhir_run4 : _menhir_env -> ('ttv_tail * _menhir_state) * Lexing.position * _menhir_state * (Ptree.ident) * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    match _tok with
...
and _menhir_goto_list_decl_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ptree.file) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState0 ->
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _menhir_s, (dl : (Ptree.file))) = _menhir_stack in
            let _2 = () in
            let _v : (Ptree.file) = 
# 61 "parser.mly"
                       ( dl )
# 2080 "parser.ml"
    ...
    | MenhirState114 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, (x : (Ptree.decl))), _, (xs : (Ptree.file))) = _menhir_stack in
        let _v : (Ptree.file) = 
# 213 "<standard.mly>"
    ( x :: xs )
# 2099 "parser.ml"
...
# 2117 "parser.ml"
    ...
    let _v : (Ptree.ident) = let _endpos = _endpos_id_ in
    let _startpos = _startpos_id_ in
...
# 2127 "parser.ml"
    ...
    | MenhirState4 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (((_menhir_stack, _menhir_s), _endpos_s_, _, (s : (Ptree.ident)), _startpos_s_), _endpos_id_, _, (id : (Ptree.ident)), _startpos_id_) = _menhir_stack in
        let _3 = () in
        let _1 = () in
        let _v : (Ptree.decl_var) = 
# 97 "parser.mly"
                                   ( Tstructp s, id )
# 2170 "parser.ml"
         in
    ...
    | MenhirState9 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s), _endpos_id_, _, (id : (Ptree.ident)), _startpos_id_) = _menhir_stack in
        let _1 = () in
        let _v : (Ptree.ident) = 
# 79 "parser.mly"
                  ( id )
# 2192 "parser.ml"
        ...
        | SEMICOLON ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _menhir_s, (x : (Ptree.ident))) = _menhir_stack in
            let _v : (Ptree.ident list) = 
# 241 "<standard.mly>"
    ( [ x ] )
# 2216 "parser.ml"
    ...
    | MenhirState20 | MenhirState16 ->
        ...
        | SEMICOLON ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _endpos_x_, _menhir_s, (x : (Ptree.ident)), _startpos_x_) = _menhir_stack in
            let _v : (Ptree.ident list) = 
# 241 "<standard.mly>"
    ( [ x ] )
# 2247 "parser.ml"
...
# 2264 "parser.ml"
    ...
    | MenhirState45 ->
        ...
        | RPAR ->
            ...
            let (((_menhir_stack, _menhir_s, _startpos__1_), _startpos__2_), _endpos_id_, _, (id : (Ptree.ident)), _startpos_id_) = _menhir_stack in
            let _5 = () in
            let _3 = () in
            let _2 = () in
            let _1 = () in
...
# 2340 "parser.ml"
        ...
        | AMPERSANDAMPERSAND | ARROW | COMMA | COMP _ | EQ | EQOP _ | MINUS | PLUS | RPAR | SEMICOLON | SLASH | STAR | VERTICALBARVERTICALBAR ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _endpos__1_, _menhir_s, (_1 : (Ptree.ident)), _startpos__1_) = _menhir_stack in
            let _startpos = _startpos__1_ in
            let _endpos = _endpos__1_ in
            let _v : (Ptree.lvalue) = 
# 102 "parser.mly"
...
# 2355 "parser.ml"
    ...
    | MenhirState65 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _endpos__1_, _menhir_s, (_1 : (Ptree.expr)), _startpos__1_), _endpos__3_, _, (_3 : (Ptree.ident)), _startpos__3_) = _menhir_stack in
        let _2 = () in
        let _startpos = _startpos__1_ in
        let _endpos = _endpos__3_ in
        let _v : (Ptree.lvalue) = 
...
and file : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Ptree.file) =
  fun lexer lexbuf ->
